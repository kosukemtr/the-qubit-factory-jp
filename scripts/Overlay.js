class Overlay {
  static createRobotScreen(e) {
    ...
    Helper.fiberBox(e, b, O, M, v, w),
      ...
      (e.textAlign = "center"),
      (e.font = (1.6 * FIELD.tileWidth) / 4 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
  ...
  static createSelect(e) {
    ...
    e.save(),
      ...
      (e.textBaseline = "top"),
      (e.textAlign = "left"),
      (e.font = (2 * FIELD.tileWidth) / 4 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      (e.fillStyle = "antiquewhite"),
      (e.shadowBlur = 2),
      (e.shadowOffsetX = 2),
      (e.shadowOffsetY = 2),
  ...
  static createTitle(e) {
    ...
    if (
      ...
      (e.textBaseline = "top"),
      (e.textAlign = "left"),
      (e.font = FIELD.tileWidth / 3 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      (e.fillStyle = "antiquewhite"),
      (e.shadowBlur = 2),
      (e.shadowOffsetX = 2),
      (e.shadowOffsetY = 2),
      ...
      (e.font = (3 * FIELD.tileWidth) / 3 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      e.fillText("Q", a / 2 + -0.65 * FIELD.tileWidth, 0.15 * FIELD.tileWidth),
      (e.font = (1 * FIELD.tileWidth) / 2 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      e.fillText(
        "ubit",
        a / 2 + -0.05 * FIELD.tileWidth,
        0.55 * FIELD.tileWidth,
      ),
      (e.font = (1.3 * FIELD.tileWidth) / 3 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      (e.textAlign = "center"),
      e.fillText(
        "Factory",
      ...
      e.save(),
        (e.textBaseline = "top"),
        (e.textAlign = "left"),
        (e.font = (1 * FIELD.tileWidth) / 4 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
        (e.fillStyle = "antiquewhite"),
        (e.shadowBlur = 2),
        (e.shadowOffsetX = 2),
        (e.shadowOffsetY = 2),
        ...
        (e.font = (1 * FIELD.tileWidth) / 6 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      ...
      e.fillText(
        ...
        (e.font = (1.5 * FIELD.tileWidth) / 6 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
        e.fillText(
          "Glen Evenbly,",
  ...
  static createTutorial(e, t) {
    ...
    if (1 === TUTORIAL.current)
      ...
      e.save(),
        (e.textBaseline = "middle"),
        (e.textAlign = "center"),
        (e.font = FIELD.tileWidth / 2 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
        (e.fillStyle = "black"),
      ...
      e.save(),
        ...
        (e.textBaseline = "middle"),
        (e.textAlign = "center"),
        (e.font = (1 * i) / 2 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
        (e.fillStyle = "antiquewhite"),
        (e.shadowBlur = 2),
        (e.shadowOffsetX = 2),
        (e.shadowOffsetY = 2),
  ...
  static create(e) {
    ...
    "chsh" === SCENARIO.name &&
      ...
      (e.textBaseline = "middle"),
      (e.textAlign = "left"),
      (e.font = (i / 2) * 1.2 + "px Verdana, 'Noto Sans JP'"),
      (e.fillStyle = "black"),
      (e.shadowBlur = 0),
      (e.shadowOffsetX = 0),
      (e.shadowOffsetY = 0),
    ...
    y.save(),
      ...
      (y.textAlign = "center"),
      (y.font = 2.8 * i + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      y.translate(
      ...
      y.rotate(-Math.PI / 6),
      y.strokeText("機密", 0, 0),
      (y.font = 1 * i + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      y.strokeText("外部共有禁止", 0, -2.2 * a);
    var N = Math.random();
    N < 1 / 3
        ? y.strokeText("違反時は感電処罰", 0, 2.2 * a)
      : N < 2 / 3
          ? ((y.font = Math.round(0.9 * i) + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
    ...
    y.stroke(W),
      ...
      (e.textBaseline = "bottom"),
      (e.textAlign = "left"),
      (e.font = (2.2 * FIELD.tileWidth) / 4 + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
      (e.fillStyle = "antiquewhite"),
      (e.shadowBlur = 2),
      (e.shadowOffsetX = 2),
      (e.shadowOffsetY = 2),
  ...
  static createInstruct(e, t, i, a = !1) {
    ...
    if (
      ...
      e.save(),
        ...
        e.translate(t / 2, i / 2),
        e.rotate(-Math.PI / 6),
        (e.font = Math.round(1 + t / 7) + "px 'Courier New', 'Noto Sans Mono CJK JP'"),
